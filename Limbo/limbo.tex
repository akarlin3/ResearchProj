...
%
% Venue: Physics in Medicine & Biology (Topical Review, IOP Publishing).
% Class : iopjournal.cls — IOP's official 2025 author class (LPPL 1.3c). It is NOT on
%   CTAN and cannot be fetched by tectonic, so iopjournal.cls + orcid.pdf are vendored
%   in this directory; see IOP_CLASS_PROVENANCE.md. Build: tectonic limbo.tex
%   (gated on verify_citations.py; see build.sh / reproduce.sh).
%
...
\usepackage{booktabs}
\usepackage[numbers,sort&compress]{natbib}   % numbered (Vancouver) references, IOP family
...
% Author list + affiliations confirmed at GATE F (solo author; all three affiliations).
\author{Avery Karlin\orcid{0000-0003-3848-6782}}

\affil{Department of Applied Physics and Applied Mathematics, Columbia University, New York, NY, USA}
\affil{Department of Computer Science, University of Colorado Boulder, Boulder, CO, USA}
\affil{The Annealing Signet Institute}

\email{averykarlin3@gmail.com}

\keywords{quantitative MRI, intravoxel incoherent motion, uncertainty quantification,
calibration, conformal prediction, value of information, MR-guided adaptive radiotherapy,
dose painting}
...
% --- iopjournal back-matter (unnumbered statement blocks) ---
\ack{The author declares no competing interests. \emph{Generative AI use disclosure:}
during the preparation of this work the author used Claude (Anthropic), including Claude
Code, for code scaffolding (the citation gate and build), manuscript drafting assistance,
and copy-editing. After using these tools the author reviewed and edited the content as
...
\roles{Avery Karlin (sole author): Conceptualization; Methodology; Software (citation gate
...
\data{This review reports no new experimental data. The verified citation base
...
% natbib's thebibliography supplies the "References" heading; no manual \section* needed.
