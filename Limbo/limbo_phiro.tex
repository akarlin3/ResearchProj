...
% Single (solo) author associated with all three affiliations; corresponding email and
% the institutional-vs-personal address are confirmed at GATE D (HUMAN). ORCID is carried
% as an author footnote (elsarticle has no \orcid macro).
